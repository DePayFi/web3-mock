...
This library supports the all crypto wallets that implement/inject window.ethereum or window.solana like:
...
await window.solana.request({ method: 'eth_chainId' }) // '0x1'
```
