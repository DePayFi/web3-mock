...
#### Contract calls for specific given blocks
...
await contract.balanceOf("0x5Af489c8786A018EC4814194dC8048be1007e390", { blockTag: 'latest' }) // raises Web3Mock: Please mock the contract call 
```
