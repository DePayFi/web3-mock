(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ethers'), require('@depay/web3-blockchains'), require('@depay/solana-web3.js'), require('@depay/web3-constants')) :
  typeof define === 'function' && define.amd ? define(['exports', 'ethers', '@depay/web3-blockchains', '@depay/solana-web3.js', '@depay/web3-constants'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Mock = {}, global.ethers, global.Web3Blockchains, global.SolanaWeb3js, global.Web3Constants));
}(this, (function (exports, ethers, web3Blockchains, solanaWeb3_js, web3Constants) { 'use strict';
  ...
  let findAnyMockForThisAddress$1 = ({ type, params }) => {
    return mocks.find((mock) => {
      ...
      if (normalize(_optionalChain$g([mock, 'access', _5 => _5[type], 'optionalAccess', _6 => _6.to])) !== normalize(params.to)) {
        return
      }
      return mock
    })
