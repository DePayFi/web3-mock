(function (global, factory) {
  ...
  let mockTransactions = function(configuration) {
    if(configuration != undefined) { mocks$1 = {}; }
    if(configuration === undefined) { return }
    let configurationWithLowerCaseAddress = {};
    for (const [address, configuration] of Object.entries(configuration)) {
      configurationWithLowerCaseAddress[normalize(address)] = configuration;
  ...
  let decodeTransactionArguments = function({ params, mock, window }){
    ...
    if(_optionalChain([mock, 'optionalAccess', _ => _.method]) && contractFunction.name != mock.method) { return undefined }
  ...
  let findMock = function({ params, mocks, window }) {
    ...
    if(_optionalChain([mock, 'optionalAccess', _2 => _2.value]) && ethers.ethers.BigNumber.from(params.value).toString() !== mock.value) { return undefined }
    if(_optionalChain([mock, 'optionalAccess', _3 => _3.from]) && normalize(params.from) !== normalize(mock.from)) { return undefined }
        ...
        return Promise.resolve(
          {
            ...
            "input": "",
            "nonce": "0x0",
