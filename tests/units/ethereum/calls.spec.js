...
describe('mock Ethereum contract calls', ()=> {
  ...
  it('fails if call was executed but there was not mock for it', async ()=>{
    ...
    await expect(
      ...
      "Web3Mock: Please mock the contract at: 0x7a250d5630b4cf539739df2c5dacb4c659f2488d"
    )
  })
  ...
  it('fails if mocked contract method was not mocked', async ()=>{
    ...
    await expect(contract.decimals()).rejects.toEqual(
      'Web3Mock: Please mock the contract at: 0xa0bed124a09ac2bd941b10349d8d224fe3c955eb'
    )
  })
