...
describe('Web3Mock Ethereum contract calls', ()=> {

  let window;
  let provider;
  let contractAddress = '0xa0bEd124a09ac2Bd941b10349d8d224fe3c955eb';
  ...
  it('resets all mocks if Web3Mock is called again', async ()=> {
    ...
    await expect(
      contract.name()
    ).rejects.toEqual('Web3Mock Ethereum calls: Please mock the contract at: 0xa0bed124a09ac2bd941b10349d8d224fe3c955eb')
  })

  it('mocks a simple call and returns the mocked value', async ()=>{
  ...
  it('throws an error if the contract was not mocked at all', async ()=>{
    ...
    await expect(contract.name()).rejects.toEqual('Web3Mock Ethereum calls: Please mock the contract at: 0xa0bed124a09ac2bd941b10349d8d224fe3c955eb')
  })

  it('throws an error if the abi for the called contract was not provided', async ()=>{
    Web3Mock({ window: window,
      mocks: {
        ethereum: {
          calls: {
    ...
    await expect(contract.name()).rejects.toEqual('Web3Mock Ethereum calls: Please mock the abi of the contract at: 0xa0bed124a09ac2bd941b10349d8d224fe3c955eb')
  })
  ...
  it('fails if mocked contract method was not mocked', async ()=>{
    ...
    await expect(contract.decimals()).rejects.toEqual(
      'Web3Mock Ethereum calls: Mock the following contract call: { \"0xa0bed124a09ac2bd941b10349d8d224fe3c955eb\": { \"decimals\" : \"Your Value\" } }'
    )
  })
  ...
  it('fails if executed call with specific arguments was not mocked', async ()=>{
    ...
    await expect(
      ...
      'Web3Mock Ethereum calls: Mock the following contract call: { \"0x7a250d5630b4cf539739df2c5dacb4c659f2488d\": { [[1000000000000000000,0xdac17f958d2ee523a2206206994597c13d831ec7,0xa0bed124a09ac2bd941b10349d8d224fe3c955eb]] : \"Your Value\" } }'
    )
  })
});
