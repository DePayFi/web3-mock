import { mock, resetMocks } from 'dist/esm/index.solana'
  ...
  supported.solana.forEach((blockchain)=>{
    ...
    describe(blockchain, ()=> {
      ...
      it('mocks signature request and returns given signature', async()=> {
        ...
        let signer = window.solana
        let signature = await signer.signMessage(encodedMessage)

        expect(signature).toEqual([145, 241, 134, 253, 144, 164, 58, 132, 158, 215, 157, 253, 203, 13, 92, 29, 13, 176, 249, 226, 36, 199, 149, 12, 100, 27, 76, 20, 160, 63, 255, 140, 6, 49, 99, 33, 41, 163, 77, 65, 238, 33, 175, 100, 147, 147, 54, 117, 79, 99, 59, 159, 228, 241, 175, 28, 255, 55, 210, 215, 55, 56, 68, 14])
      })
    })
  })
})
