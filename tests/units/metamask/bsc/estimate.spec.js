...
describe('mock bsc estimates', ()=> {
  ...
  it('requires mocks and suggests how to mock in case estimate mocks have been required', async ()=> {
    ...
    mock({ blockchain: 'bsc', require: 'estimate' })
    ...
    await expect(
      ...
      "Web3Mock: Please mock the estimate: {\"blockchain\":\"bsc\",\"estimate\":{\"to\":\"0xa0bed124a09ac2bd941b10349d8d224fe3c955eb\",\"api\":[\"PLACE API HERE\"],\"return\":\"ESTIMATED GAS\"}}"
    )
  })
