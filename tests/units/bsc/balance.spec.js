...
describe('mock bsc balances', ()=> {
  ...
  it('suggests how to mock a balance', async ()=>{
    ...
    await expect(
      ...
      "Web3Mock: Please mock the balance request: {\"blockchain\":\"bsc\",\"balance\":{\"for\":\"0xb0252f13850a4823706607524de0b146820f2240\",\"return\":\"PUT BALANCE AMOUNT HERE\"}}"
    )
  })
