...
describe('evm mock given provider (evm)', ()=> {
  ...
  supported.evm.forEach((blockchain)=>{
    ...
    describe(blockchain, ()=> {
      ...
      it('allows you to mock web3 requests for a given provider', async ()=>{
        ...
        let provider = new JsonRpcProvider('https://example.com');
      ...
      it('allows to mock a fallbackprovider', async()=>{
        let provider = new FallbackProvider([{ provider: new ethers.providers.StaticJsonRpcProvider('https://cloudflare-eth.com', 1) }], 1)
