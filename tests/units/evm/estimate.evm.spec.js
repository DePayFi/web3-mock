...
import { mock, resetMocks, confirm, anything } from 'dist/esm/index.evm'
import { supported } from "src/blockchains"

describe('mock evm estimates (evm)', ()=> {
    ...
    describe(blockchain, ()=> {
      ...
      it('requires mocks and suggests how to mock in case estimate mocks have been required', async ()=> {
        ...
        await expect(
          ...
          `Web3Mock: Please mock the estimate: {\"blockchain\":\"${blockchain}\",\"estimate\":{\"to\":\"0xa0bed124a09ac2bd941b10349d8d224fe3c955eb\",\"api\":[\"PLACE API HERE\"],\"return\":\"ESTIMATED GAS\"}}`
        )
      })
